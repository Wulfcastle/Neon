...
var licenses = db.collection('licenses');
...
exports.findLicense = function(user, callback) {
  licenses.findOne({user: user}, function(e, o){
      callback(e, o);
  });
}

exports.addNewLicense = function(newData)
{
  newData.date = moment().format('MMMM Do YYYY, h:mm:ss a');
  licenses.insert(newData, {safe: true});
}
...
exports.makeTextLicense = function(email, game, name) {
    var textfile = "Nickname: " + name + "\nE-Mail: " + email + "\nProduct: " + game;
    var hash = sha256(textfile);
    var finalLicense="Hash: " + hash + "\n" + textfile;
    return finalLicense;
}